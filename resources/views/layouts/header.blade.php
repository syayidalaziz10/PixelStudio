...
<body class="font-poppins">
    <header>
        <nav class="p-2 w-full fixed backdrop-blur-sm top-0">
            <div class="flex flex-wrap items-center justify-between px-44 py-5">
                ...
                <div class="text-secondary">
                    <ul class="flex flex-col items-center p-2 mt-4 border rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:border-0">
                            ...
                            <div>
                                <div class="dropdown inline-block relative">
                                    <button class="border-2 border-secondary text-secondary p-2 rounded inline-flex items-center">
                                        <span class="mr-1 break-words">Hallo! {{ auth()->user()->nama}}</span>
                                    ...
                                    <ul class="dropdown-menu absolute hidden text-secondary pt-1">
                                        ...
                                        <form action="/logout" method="POST">
                                            @csrf
                                            <li class=""><button type="submit" class="rounded-b bg-neutral hover:bg-gray-400 py-2 pl-4 pr-6 block whitespace-no-wrap" href="#">Logout</button></li>
                                        </form>
                                    </ul>
                                </div>
                            </div>
